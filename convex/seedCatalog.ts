    ...
    const products = [
      {
        ...
        variables: [
          { name: 'nights',  role: 'time',     min: 1,  max: 30, hint: 'How many nights?' },
          { name: 'rooms',   role: 'quantity',  min: 1,  max: 5,  hint: 'How many rooms?' },
          { name: 'guests',  role: 'quantity',  min: 1,  max: 10, hint: 'How many guests?' },
        ],
      ...
      },
      {
        ...
        variables: [
          { name: 'guests',  role: 'quantity', min: 1, max: 20, hint: 'How many guests?' },
          { name: 'cabanas', role: 'quantity', min: 0, max: 5,  hint: 'How many private cabanas? (0 for none)' },
        ],
      ...
      },
      {
        ...
        variables: [
          { name: 'guests',    role: 'quantity', min: 1, max: 6,  hint: 'How many guests?' },
          { name: 'nights',    role: 'time',     min: 3, max: 14, hint: 'How many nights?' },
          { name: 'has_suite', role: 'quantity', min: 0, max: 1,  hint: 'Suite upgrade? 1=Yes 0=No' },
        ],
      ...
      },
      {
        ...
        variables: [
          { name: 'attendees',       role: 'quantity', min: 10, max: 500, hint: 'How many attendees?' },
          { name: 'duration_hours',  role: 'time',     min: 2,  max: 12,  hint: 'How many hours?' },
        ],
      ...
      },
      {
        ...
        variables: [
          { name: 'travelers',          role: 'quantity', min: 1, max: 10, hint: 'How many travelers?' },
          { name: 'hotel_nights',        role: 'time',     min: 0, max: 14, hint: 'How many hotel nights needed?' },
          { name: 'airport_transfers',   role: 'quantity', min: 0, max: 10, hint: 'How many airport transfers?' },
        ],
